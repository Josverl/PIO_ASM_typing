...
if TYPE_CHECKING:
    ...
    def delay(delay) -> PIOASMEmit:
        """Delay for the given number of cycles."""
        ...

    def side(value) -> PIOASMEmit:
        """
        This allows the sideset pins to be set to a value other than 0 or 1.
        Drive the pin configured for side-set with the given value.
        .set(n) is used with sideset pins
        """
        ...
